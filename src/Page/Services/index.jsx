	...
	const base = [
		{
			...
			slide_items: [
				...
				{
					link: "/services/2",
					item: "Создание интернет-магазинов",
				},
				{
					link: "/services/3",
					item: "Создание CRM-систем",
				},
				{
					link: "/services/4",
					item: "Создание сайтов под ключ",
				},
				{
					link: "/services/5",
					item: "Мобильная версия сайта",
				},
				{
					link: "/services/6",
					item: "Web-программирование",
				},
			],
		},
		{
			...
			slide_items: [
				...
				{
					link: "/services/10",
					item: "Разработка уникальной графики",
				},
				{
					link: "/services/11",
					item: "Перевод растровых элементов в векторные",
				},
				{
					link: "/services/12",
					item: "Вёрстка",
				...
				<div className='wrapper'>
					<div className='services_container'>
						...
						<div className='shift_description light_text'>
							Веб - студия International Techno Dynamics – надежный и опытный
							помощник в разработке сайтов любого вида. Мы готовы создать
							корпоративный сайт Вашей компании, с нуля разработать и запустить
							интернет-магазин, продумать в деталях эффективный landing, сделать
							все, чтобы сайт-визитка заинтересовал новых клиентов. Учитывая
							Ваши пожелания и идеи, мы разработаем web-дизайн для Вашего сайта.
							А для того, чтобы Ваш бизнес успешно развивался в сети, мы
							предлагаем грамотное продвижение Вашего сайта. Если Вы доверите
							нам свой проект, мы воплотим Вашу идею в жизнь.
						</div>
